        ...
        <ScrollView style={{ padding: 40 }}>
          ...
          <View style={styles.ScndView}>
            ...
            <Text>Create an account</Text>
              ...
              <Button
                disabled={!isValid}
                style={{ marginTop: 20, padding: 10 }} mode="contained" onPress={() => { console.log("done") }}>
                Login
              </Button>
            ...
            <View style={styles.footer}>
              <Text style={{ textAlign: 'center', textDecorationLine: 'underline' }} onPress={() => { navigation.navigate('AdminLogin') }}>Login instead</Text>
            </View>
